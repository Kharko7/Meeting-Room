...
const InputComponent = ({register, name, required, placeHolder, error, type, IsRegister}: IInput) => {
    ...
    const {reg, iconPath, message}: ICheckType = checkType(type);
...
function checkType(type: string) {
    ...
    switch (type) {
        case "password":
            ...
            check.message = `Please enter a valid ${type}.\nThe minimum password length is 8 characters.\nIt must contain common letters, symbols and numbers`;
            break;
        case "":
            ...
            check.message = `Please enter a valid email`;
            break
        case "login":
            ...
            check.message = `Please enter a valid ${type}.\nThe minimum length of the login is 3 characters.\nThe use of special characters is prohibited`;
            break;
        default :
