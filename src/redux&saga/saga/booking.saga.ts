...
import { addBookingSuccess, deleteBookingSuccess, getAllBookingsSuccess, setBookingError, setLoading, editOneBookingSuccess, editRecurringBookingSuccess } from 'redux&saga/slices/booking.slice';
import dayjs from "dayjs";
import utc from 'dayjs/plugin/utc';
import { DeleteBookingInterface, OneBooking, EditRecurringBooking, AddRecurringBooking } from 'interfaces/booking/Booking';
...
export function* addOneBooking(action: PayloadAction<OneBooking>) {
    try {
        ...
        const { title, startDateTime, endDateTime, bookingId, room_FK, description, isRecurring, recurringId } = response.data
